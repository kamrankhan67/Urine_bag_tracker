              ...
              StreamBuilder(
                ...
                builder: (context, AsyncSnapshot snapshot) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      DocumentSnapshot ds = snapshot.data!.docs[index];
                      if (ds.id == "Waste" || ds.id == "Ready Bags") {
                        return const SizedBox.shrink(); // Skip Waste and Ready Bags
                      }
                      return GestureDetector(
                        onLongPress: () {
                          _showEditDeleteDialog(ds.id);
                        },
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => LabourPerson(category: ds),)),
                        child: _labourContainer(ds.id, context),
                      );
                    },
                  );
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Spacer(),
                      AddButton(
                        fn: () => _addLabourCategory(
                          _addSupplierController.text,
                          context,
                        ),
                      ),
                    ],
